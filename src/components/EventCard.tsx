...
export default function EventCard({ event }: { event: FlourishEvent }) {
  return (
    <div className="flex flex-col overflow-hidden rounded-2xl bg-white shadow-[0_1px_2px_rgba(36,31,33,0.06)] transition-shadow hover:shadow-[0_18px_40px_-16px_rgba(58,15,43,0.25)]">
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="mt-5 flex items-center justify-between border-t border-charcoal/10 pt-4">
          ...
          <Link
            ...
            className="font-sans text-xs font-semibold uppercase tracking-[0.1em] text-plum hover:text-burgundy"
          >
            Details →
          </Link>
        </div>
