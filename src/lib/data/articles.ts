...
export const articles: Article[] = [
  {
    ...
    heroImage: { alt: "Editorial photo for From Brokenness to Wholeness", tone: "burgundy", motif: "vine" },
    isNew: true,
    priority: 1,
    editorsPick: true,
  ...
  },
  {
    ...
    heroImage: { alt: "Editorial photo for Faith That Presses Through", tone: "plum", motif: "wheat" },
    isNew: true,
    priority: 2,
    trending: true,
  ...
  },
  {
    ...
    readingTimeMinutes: 6,
    heroImage: { alt: "Editorial photo for Gratitude in the Dark", tone: "charcoal", motif: "olive" },
    isNew: true,
    priority: 3,
  ...
  },
  {
    ...
    heroImage: { alt: "Editorial photo for Seasons of Waiting", tone: "plum", motif: "wheat" },
    featured: true,
    editorsPick: true,
  ...
  },
  {
    ...
    readingTimeMinutes: 6,
    heroImage: { alt: "Editorial photo for The Quiet Strength of Purpose", tone: "gold", motif: "vine" },
    featured: false,
    trending: true,
  ...
  },
  {
    ...
    readingTimeMinutes: 8,
    heroImage: { alt: "Editorial photo for Raising Children Who Know the Lord", tone: "rose", motif: "fern" },
    featured: false,
    editorsPick: true,
  ...
  },
  {
    ...
    readingTimeMinutes: 6,
    heroImage: { alt: "Editorial photo for Rest Is Not a Reward", tone: "burgundy", motif: "lily" },
    featured: false,
  ...
  },
  {
    ...
    heroImage: { alt: "Editorial photo for The Art of Gracious Hospitality", tone: "gold", motif: "olive" },
  ...
  },
  {
    ...
    readingTimeMinutes: 7,
    heroImage: { alt: "Editorial photo for Healing from Comparison", tone: "plum", motif: "lily" },
    trending: true,
  ...
  },
  {
    ...
    readingTimeMinutes: 6,
    heroImage: { alt: "Editorial photo for Leading with Conviction and Compassion", tone: "charcoal", motif: "palm" },
    tags: ["leadership"],
    body: [
  ...
  },
  {
    ...
    heroImage: { alt: "Editorial photo for A Simple Morning Prayer Practice", tone: "burgundy", motif: "olive" },
    editorsPick: true,
  ...
  },
  {
    ...
    heroImage: { alt: "Editorial photo for You Are Not Behind", tone: "gold", motif: "wheat" },
    trending: true,
    tags: ["encouragement"],
    body: [
