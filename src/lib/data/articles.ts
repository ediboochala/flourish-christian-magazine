...
export const articles: Article[] = [
  ...
  },
  {
    ...
    heroImage: { alt: "Editorial photo for Seasons of Waiting", tone: "plum" },
    featured: true,
    editorsPick: true,
  ...
  },
  {
    ...
    readingTimeMinutes: 6,
    heroImage: { alt: "Editorial photo for The Quiet Strength of Purpose", tone: "gold" },
    featured: false,
    trending: true,
  ...
  },
  {
    ...
    readingTimeMinutes: 8,
    heroImage: { alt: "Editorial photo for Raising Children Who Know the Lord", tone: "rose" },
    featured: false,
    editorsPick: true,
  ...
  },
  {
    ...
    readingTimeMinutes: 6,
    heroImage: { alt: "Editorial photo for Rest Is Not a Reward", tone: "burgundy" },
    featured: false,
  ...
  },
  {
    ...
    readingTimeMinutes: 7,
    heroImage: { alt: "Editorial photo for Healing from Comparison", tone: "plum" },
    trending: true,
  ...
  },
  {
    ...
    heroImage: { alt: "Editorial photo for A Simple Morning Prayer Practice", tone: "burgundy" },
    editorsPick: true,
  ...
  },
  {
    ...
    heroImage: { alt: "Editorial photo for You Are Not Behind", tone: "gold" },
    trending: true,
    tags: ["encouragement"],
    body: [
